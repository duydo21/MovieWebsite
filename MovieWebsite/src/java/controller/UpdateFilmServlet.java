...
public class UpdateFilmServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Film film = dao.getFilmByMS(movieid);
        if(film==null){
            request.setAttribute("err", "Film not found!");
            request.getRequestDispatcher("update.jsp").forward(request, response);
        }else{
            request.setAttribute("movieid", film.getMovieid());
            request.setAttribute("filmname", film.getMoviename());
